...
if (typeof localStorage.getItem('recipes') === 'undefined' || localStorage.getItem('recipes') === null) {
    const recipeData1 = {
      ...
      const recipeData4 = {
        ...
        id: incId(),
        ingredients: ["½ cup butter",  "1 ½ tablespoons garlic powder", "1 tablespoon dried parsley", "1 (1 pound) loaf Italian bread, cut into 1/2 inch slices", "1 (8 ounce) package shredded mozzarella cheese"],
        directions: [
          "Gather all ingredients.", "Preheat the oven to 350 degrees F (175 degrees C).", "Melt butter in a small saucepan over medium heat; stir in garlic powder and dried parsley.",
          "Place bread slices on a medium baking sheet. Using a basting brush, brush bread generously with melted butter mixture.", "Bake in the preheated oven until lightly toasted, about 10 minutes.",
      ...
      const recipeData5 = {
        ...
        id: incId(),
        ingredients: ["2 tablespoons butter", "3 skinless, boneless chicken breast halves", "1 ½ teaspoons salt", "1 ½ teaspoons ground black pepper", "2 tablespoons garlic powder, divided", "1 lemon, juiced"],
        directions: [
      ...
      const recipeData6 = {
        ...
        id: incId(),
        ingredients: ["¼ cup olive oil", "1 tablespoon minced garlic", "½ teaspoon sea salt", "8 Roma tomatoes, sliced", "2 (12 inch) pre-baked pizza crusts", "8 ounces shredded Mozzarella cheese", "4 ounces shredded Fontina cheese", "10 fresh basil leaves, washed, dried", "½ cup freshly grated Parmesan cheese", "½ cup crumbled feta cheese"],
        directions: [
      ...
      const recipeData7 = {
        ...
        recipeName: "Pumpkin",
        id: incId(),
        ingredients: ["1 (15.25 ounce) package yellow cake mix, divided", "⅓ cup unsalted butter, melted", "1 large egg","1 (29 ounce) can pumpkin puree", "3 large eggs", "⅔ cup milk", "½ cup brown sugar", "2 tablespoons pumpkin pie spice", "½ cup white sugar", "¼ cup cold unsalted butter, cubed", "¾ cup chopped walnuts"],
        directions: [
      ...
      const recipeData8 = {
        ...
        id: incId(),
        ingredients: ["2 pounds medium raw shrimp, shelled, deveined, with tails attached", "1 cup butter", "2 tablespoons Dijon mustard", "1 tablespoon fresh lemon juice", "1 tablespoon chopped garlic", "1 tablespoon chopped fresh parsley"],
        directions: [
      ...
      const recipeData10 = {
        ...
        id: incId(),
        ingredients: ["1 tablespoon vegetable oil", "½ medium onion, sliced", "1 tablespoon fresh ginger root, finely chopped", "2 cloves garlic, finely chopped", "1 (16 ounce) package tofu, drained and cut into cubes", "1 cup baby corn, drained and cut into pieces", "1 green bell pepper, seeded and cut into strips", "1 carrot, peeled and sliced", "1 small head bok choy, chopped", "2 cups fresh mushrooms, chopped", "1 ¼ cups bean sprouts", "1 cup bamboo shoots, drained and chopped", "½ teaspoon crushed red pepper", "½ cup water", "¼ cup rice wine vinegar", "2 tablespoons honey", "2 tablespoons soy sauce", "2 tablespoons water", "2 teaspoons cornstarch", "2 medium green onions, thinly sliced diagonally"],
        directions: [
      ...
      const recipeData11 = {
        ...
        id: incId(),
        ingredients: ["80ml (1/3 cup) olive oil", "1 large onion, peeled, finely chopped", "1 small red chilli, seeded, chopped", "1/2 red capsicum, chopped", "1/4 tsp chilli flakes", "1/2 tsp ground cinnamon", "1 tsp ground cumin", "1 tsp dried thyme", "2-3 garlic cloves, crushed", "420g can mixed beans, drained, rinsed", "420g can lentils, drained, rinsed", "Mutti Polpa Finely Chopped Tomatoes 400g", "1 tbsp Mutti Double Concentrate Tomato Paste", "1 cup chopped flat-leaf parsley"],
        directions: [
      ...
      const recipeData12 = {
        ...
        id: incId(),
        ingredients: ["2 ¼ cups creamy peanut butter", "½ cup butter", "4 cups confectioners' sugar", "3 cups crisp rice cereal", "2 cups semisweet chocolate chips"],
        directions: [
          "Gather all ingredients.",
      ...
      const recipeData13 = {
        ...
        id: incId(),
        ingredients: ["4 Tablespoons olive oil", "1 teaspoon oregano", "1/2 teaspoon paprika powder", "1 teaspoon salt more or less to taste", "1/2 teaspoon black pepper", "3 garlic minced cloves", "1/2 cup chopped red onion", "1 red bell pepper chopped", "1/2 cup chopped carrots", "1 cup frozen peas", "1 bay leaf", "3 cups long grain rice rinsed", "4 cups low sodium chicken or vegetable broth", "1/4 cup fresh dill for garnish optional"],
        directions: [
